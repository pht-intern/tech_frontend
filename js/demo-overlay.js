(function() {
    var STEPS = {
        owner: [
            ...
            { target: '#priceColHeader', title: 'Price Sort', icon: 'fa-sort', desc: '<strong>Sort</strong> products by price (click the Price column header).', switchTab: 'itemsList' },
            ...
            { target: '#cust-name', title: 'Customer Quotation Details', icon: 'fa-user', desc: 'Customer <strong>name</strong>, <strong>phone</strong>, <strong>email</strong>, <strong>address</strong>. <strong>Phone is required</strong>.', switchTab: 'createQuotation', targetClosest: '.card' },
        ...
        admin: [
            ...
            { target: 'a[data-tab="createQuotation"]', title: 'Quotations', icon: 'fa-file-invoice-dollar', desc: '<strong>Navigate</strong> to quotations. Create and manage <strong>quotes</strong>.' },
            { target: '#cust-name', title: 'Customer Quotation Details', icon: 'fa-user', desc: 'Customer <strong>name</strong>, <strong>phone</strong>, <strong>email</strong>, <strong>address</strong>. <strong>Phone required</strong>.', switchTab: 'createQuotation', targetClosest: '.card' },
        ...
        manager: [
            ...
            { target: '#cust-name', title: 'Customer Quotation Details', icon: 'fa-user', desc: '<strong>Name</strong>, <strong>phone</strong>, <strong>email</strong>, <strong>address</strong>.', switchTab: 'createQuotation', targetClosest: '.card' },
        ...
        employee: [
            ...
            { target: '#recentActivityList', title: 'Recent Activity', icon: 'fa-bolt', desc: 'Latest <strong>actions and changes</strong>.', switchTab: 'dashboard', targetClosest: '.card' },
            { target: 'a[data-tab="createQuotation"]', title: 'Quotations', icon: 'fa-file-invoice-dollar', desc: '<strong>Navigate</strong> to quotations.' },
            { target: '#cust-name', title: 'Customer Quotation Details', icon: 'fa-user', desc: '<strong>Name</strong>, <strong>phone</strong>, <strong>email</strong>, <strong>address</strong>. Phone required.', switchTab: 'createQuotation', targetClosest: '.card' },
            { target: '#quotationItemsBody', title: 'Quotation Items', icon: 'fa-shopping-cart', desc: 'Items in quotation. <strong>Set quantity</strong>, <strong>price</strong>.', switchTab: 'createQuotation', targetClosest: '.card' },
